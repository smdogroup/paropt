...
*/
void CyParOptProblem::setInequalityOptions(int _isSparseInequal, int _useLower,
                                           int _useUpper) {
...
*/
int CyParOptProblem::isSparseInequality() { return isSparseInequal; }
int CyParOptProblem::useLowerBounds() { return useLower; }
int CyParOptProblem::useUpperBounds() { return useUpper; }

/*
  Set the member callback functions that are required
*/
void CyParOptProblem::setSelfPointer(void *_self) { self = _self; }

void CyParOptProblem::setGetVarsAndBounds(void (*func)(void *, int, ParOptVec *,
                                                       ParOptVec *,
                                                       ParOptVec *)) {
  getvarsandbounds = func;
}

void CyParOptProblem::setEvalObjCon(int (*func)(void *, int, int, ParOptVec *,
                                                ParOptScalar *,
                                                ParOptScalar *)) {
  evalobjcon = func;
}

void CyParOptProblem::setEvalObjConGradient(
    int (*func)(void *, int, int, ParOptVec *, ParOptVec *, ParOptVec **)) {
  evalobjcongradient = func;
}

void CyParOptProblem::setEvalHvecProduct(
    int (*func)(void *, int, int, int, ParOptVec *, ParOptScalar *, ParOptVec *,
                ParOptVec *, ParOptVec *)) {
  evalhvecproduct = func;
}

void CyParOptProblem::setEvalHessianDiag(
    int (*func)(void *, int, int, int, ParOptVec *, ParOptScalar *, ParOptVec *,
                ParOptVec *)) {
  evalhessiandiag = func;
}

void CyParOptProblem::setComputeQuasiNewtonUpdateCorrection(
...
void CyParOptProblem::setAddSparseJacobian(void (*func)(
    void *, int, int, ParOptScalar, ParOptVec *, ParOptVec *, ParOptVec *)) {
  addsparsejacobian = func;
}

void CyParOptProblem::setAddSparseJacobianTranspose(void (*func)(
    void *, int, int, ParOptScalar, ParOptVec *, ParOptVec *, ParOptVec *)) {
  addsparsejacobiantranspose = func;
}

void CyParOptProblem::setAddSparseInnerProduct(
...
*/
void CyParOptProblem::getVarsAndBounds(ParOptVec *x, ParOptVec *lb,
                                       ParOptVec *ub) {
  if (!getvarsandbounds) {
...
*/
int CyParOptProblem::evalObjCon(ParOptVec *x, ParOptScalar *fobj,
                                ParOptScalar *cons) {
  if (!evalobjcon) {
...
*/
int CyParOptProblem::evalObjConGradient(ParOptVec *x, ParOptVec *g,
                                        ParOptVec **Ac) {
...
*/
int CyParOptProblem::evalHvecProduct(ParOptVec *x, ParOptScalar *z,
...
*/
int CyParOptProblem::evalHessianDiag(ParOptVec *x, ParOptScalar *z,
...
*/
void CyParOptProblem::computeQuasiNewtonUpdateCorrection(
...
*/
void CyParOptProblem::evalSparseCon(ParOptVec *x, ParOptVec *out) {
  if (!evalsparsecon) {
...
*/
void CyParOptProblem::addSparseJacobian(ParOptScalar alpha, ParOptVec *x,
...
*/
void CyParOptProblem::addSparseInnerProduct(ParOptScalar alpha, ParOptVec *x,
