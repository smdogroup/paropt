...
class CyParOptProblem : public ParOptProblem {
 public:
  ...
  void setGetVarsAndBounds(void (*func)(void *, int, ParOptVec *, ParOptVec *,
                                        ParOptVec *));
  void setEvalObjCon(int (*func)(void *, int, int, ParOptVec *, ParOptScalar *,
                                 ParOptScalar *));
  ...
  void setComputeQuasiNewtonUpdateCorrection(
      void (*func)(void *, int, int, ParOptVec *, ParOptScalar *, ParOptVec *,
                   ParOptVec *, ParOptVec *));
  void setEvalSparseCon(void (*func)(void *, int, int, ParOptVec *,
                                     ParOptVec *));
  void setAddSparseJacobian(void (*func)(void *, int, int, ParOptScalar,
                                         ParOptVec *, ParOptVec *,
                                         ParOptVec *));
 ...
 private:
  ...
  void (*getvarsandbounds)(void *self, int nvars, ParOptVec *x, ParOptVec *lb,
                           ParOptVec *ub);
  int (*evalobjcon)(void *self, int nvars, int ncon, ParOptVec *x,
                    ParOptScalar *fobj, ParOptScalar *cons);
  int (*evalobjcongradient)(void *self, int nvars, int ncon, ParOptVec *x,
                            ParOptVec *gobj, ParOptVec **A);
  ...
  void (*evalsparsecon)(void *self, int nvars, int nwcon, ParOptVec *x,
                        ParOptVec *out);
  void (*addsparsejacobian)(void *self, int nvars, int nwcon,
                            ParOptScalar alpha, ParOptVec *x, ParOptVec *px,
                            ParOptVec *out);
