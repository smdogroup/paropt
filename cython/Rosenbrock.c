...
Rosenbrock::Rosenbrock( MPI_Comm comm, int _nvars,
...
int Rosenbrock::isSparseInequality(){ return 1; }
int Rosenbrock::isDenseInequality(){ return 1; }
int Rosenbrock::useLowerBounds(){ return 0; }
int Rosenbrock::useUpperBounds(){ return 0; }

// Get the variables/bounds
void Rosenbrock::getVarsAndBounds( ParOptVec *xvec,
				   ParOptVec *lbvec, 
				   ParOptVec *ubvec ){
  double *x, *lb, *ub;
  xvec->getArray(&x);
...
// --------------------------------------
int Rosenbrock::evalObjCon( ParOptVec *xvec, 
...
// -----------------------------------------------
int Rosenbrock::evalObjConGradient( ParOptVec *xvec,
...
// ---------------------------------------------------------
int Rosenbrock::evalHvecProduct( ParOptVec *xvec,
...
// ------------------------
void Rosenbrock::evalSparseCon( ParOptVec *x, ParOptVec *out ){
...
// --------------------------------------------------
void Rosenbrock::addSparseJacobian( double alpha, ParOptVec *x,
...
// -----------------------------------------------------------------
void Rosenbrock::addSparseJacobianTranspose( double alpha, ParOptVec *x,
...
// ------------------------------------------------------------
void Rosenbrock::addSparseInnerProduct( double alpha, ParOptVec *x,
